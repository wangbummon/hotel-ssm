...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {
            background: url(${pageContext.request.contextPath}/static/layui/images/icon-login.png) no-repeat 1px 0;
        }

        .login-main .login-bottom .center .item .icon-2 {
            background: url(${pageContext.request.contextPath}/static/layui/images/icon-login.png) no-repeat -54px 0;
        }

        .login-main .login-bottom .center .item .icon-3 {
            background: url(${pageContext.request.contextPath}/static/layui/images/icon-login.png) no-repeat -106px 0;
        }

        .login-main .login-bottom .center .item .icon-4 {
            background: url(${pageContext.request.contextPath}/static/layui/images/icon-login.png) no-repeat 0 -43px;
            position: absolute;
            right: -10px;
            cursor: pointer;
        }
        ...
        .login-main .login-bottom .center .item .icon-5 {
            background: url(${pageContext.request.contextPath}/static/layui/images/icon-login.png) no-repeat -55px -43px;
        }

        .login-main .login-bottom .center .item .icon-6 {
            background: url(${pageContext.request.contextPath}/static/layui/images/icon-login.png) no-repeat 0 -93px;
            position: absolute;
            right: -10px;
            margin-top: 8px;
            cursor: pointer;
        ...
        .login-main .login-bottom .tip .icon-check {
            ...
            height: 14px;
            border: none;
            background: url(${pageContext.request.contextPath}/static/layui/images/icon-login.png) no-repeat -111px -48px;
        }
        ...
        body {
            background: url(${pageContext.request.contextPath}/static/layui/images/get_away.png) 0% 0% / cover no-repeat;
            position: static;
            font-size: 12px;
        }
        ...
        <form class="layui-form login-bottom" action="/login" method="post">
            ...
            <div class="center">
                <div class="item">
                    ...
                    <input type="text" name="username" lay-verify="required" lay-reqText="请输入用户名" placeholder="请输入用户名"
                           maxlength="24"/>
                </div>

                <div class="item">
                    <span class="icon icon-3"></span>
                    <input type="password" name="password" lay-verify="required" lay-reqText="请输入密码" placeholder="请输入密码"
                           maxlength="20">
