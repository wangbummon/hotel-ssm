layui.define(["jquery", "layer", "form"], function (e) {
    var y = layui.$, f = layui.layer, r = layui.form, m = "dtree-nav-ul-sid", k = "dtree-nav-item", S = "dtree-nav-div",
        ...
        C = "dtree-nav-show", T = "dtree-nav-hide", x = "dtree-disabled", I = "dtree-icon-hide", a = y("body"),
        u = y(window), p = (y(document), "dtree"), b = {}, j = {}, P = "dtree-icon-fuxuankuangxuanzhong",
        A = "dtree-icon-fuxuankuang", w = "dtree-icon-fuxuankuang-banxuan", q = "dtree-icon-move-down",
        ...
        M = "dtree-icon-search_list_light", H = "dtree-icon-pulldown", U = "dtree-icon-pullup",
        B = "dtree-icon-roundadd", V = "dtree-icon-bianji", W = "dtree-icon-roundclose", $ = {
    ...
    be.prototype.setting = function (e) {
        ...
        e.obj.before(n);
        var s = "style=";
        this.selectCardHeight && (s += "'height:" + e.selectCardHeight + "px'"), e.obj.wrap('<div class="layui-card dtree-select" dtree-id="' + t + '" dtree-card="' + e.selectCardDiv + '" ' + s + "></div>").wrap('<div class="layui-card-body"></div>').wrap('<div id="' + e.selectTreeDiv + '"></div>')
        ...
        var s = "style=";
        this.selectCardHeight && (s += "'height:" + e.selectCardHeight + "px'"), y("div[dtree-id='" + t + "'][dtree-card='" + e.selectCardDiv + "']").attr("style", s)
        ...
        return e.nodeId && !e.context && (i = t.getParam(e.nodeId)), y("div[dtree-select='" + t.selectDiv + "']").find("input[dtree-id='" + o + "'][name='" + t.selectTipsName + "']").val(i || ""), n
        ...
        if (void 0 === t) this.usefontStyle.checkbox.on = "" == o ? e + " " + P : o, this.usefontStyle.checkbox.out = "" == a ? e + " " + A : a, this.usefontStyle.checkbox.noall = "" == i ? e + " " + w : i; else {
            var n = t.on, s = t.out, r = t.noall;
            this.usefontStyle.checkbox.on = void 0 === n ? "" == o ? e + " " + P : o : e + " " + n, this.usefontStyle.checkbox.out = void 0 === s ? "" == a ? e + " " + A : a : e + " " + s, this.usefontStyle.checkbox.noall = void 0 === r ? "" == i ? e + " " + w : i : e + " " + r
        }
        ...
        if (t != e.length) {
            var a = o.getNode(e[t]);
            if (a && 0 < a.length) {
                var i = a.next("ul"), n = o.getNodeDom(a).fnode(), s = o.getNodeDom(a).snode();
                i.addClass(C), o.accordionUL(i), o.operateIcon(n, s).open(), o.getChild(a, void 0, function () {
        ...
        var t = this;
        "object" == typeof t ? (t.autoHeight(), t.data ? t.dataLoadTree(!0, t.obj, t.data) : t.asyncLoadTree(!0, t.obj, e)) : f.msg("树组件未成功加载，请检查配置", {icon: 5})
    }, be.prototype.getChild = function (e, t, o) {
        var a = e.next("ul");
        this.setNodeParam(e), void 0 !== t ? this.dataLoadTree(!1, a, t) : this.asyncLoadTree(!1, a, o)
    }, be.prototype.dataLoadTree = function (a, i, n) {
        var s = this;
        if (void 0 !== n.length) if (a && 0 == n.length) i.html(s.getNoneDom().text()); else {
            i.html("");
            var r = s.load ? f.load(1) : "";
            setTimeout(function () {
                s.success(n, i, a);
                var e = 1 == a ? i.attr("data-id") : s.node.nodeId, t = 1 == a ? 1 : parseInt(s.node.level) + 1;
                if ("list" == s.dataFormat) {
                    var o = s.queryListTreeByPid(e, n);
                    s.loadListTree(o, s.data, t)
                } else s.loadTree(n, t);
                s.showLine(), s.toolbar && "contextmenu" != s.toolbarWay && s.setToolbarDom().setToolbarPlace(s.toolbarMenu), s.msgErrData(), a && s.select && s.selectInitVal && (s.checkbar ? (s.chooseDataInit(s.selectInitVal), s.selectCheckboxVal(s.selectInitVal)) : (s.dataInit(s.selectInitVal), s.selectVal(s.selectInitVal))), s.bak = s.obj.html(), s.done(s.data, i, a), s.load && f.close(r)
            }, 100)
        } else f.msg("数据解析异常，data数据格式不正确", {icon: 5})
        ...
        if (d.url) {
            ...
            fe({
                ...
                beforeSend: function (e, t) {
                    ...
                    return o || d.load && f.close(a), o
                },
                success: function (e) {
                    "string" == typeof e && (e = y.parseJSON(e)), d.success(e, r, s);
                    var t = "";
                    if ((t = "layuiStyle" == d.dataStyle ? e[d.response.statusName] : e.status[d.response.statusName]) == d.response.statusCode) {
                        ...
                        var a = 1 == s ? r.attr("data-id") : d.node.nodeId, i = 1 == s ? 1 : parseInt(d.node.level) + 1;
                        ...
                        d.showLine(), d.toolbar && "contextmenu" != d.toolbarWay && d.setToolbarDom().setToolbarPlace(d.toolbarMenu), d.msgErrData(), s || r.addClass(C), s && d.select && d.selectInitVal && (d.checkbar ? (d.chooseDataInit(d.selectInitVal), d.selectCheckboxVal(d.selectInitVal)) : (d.dataInit(d.selectInitVal), d.selectVal(d.selectInitVal))), d.bak = d.obj.html(), d.done(e, r, s), l && l()
                ...
                error: function (e, t, o) {
                    d.obj.html(d.getNoneDom().errText(t + ": " + o)), d.error(e, t, o)
                },
                complete: function (e, t) {
                    d.load && f.close(a), d.complete(e, t)
                }
            })
        } else f.msg("数据请求异常，url参数未指定", {icon: 5})
            ...
            fnode: function () {
                ...
                if ("node" == f.checkbarLoad ? b && (e = !0) : d && b && (e = !0), e) {
                    ...
                    if (c && 0 < c.length) for (var o = 0; o < c.length; o++) {
                        var a = c[o], i = a[f.response.checked], n = a[f.response.type],
                        ...
                        var r = "";
                        u && (r = x), t += "<i class='" + s + " " + f.style.dfont + " " + f.style.cbox + " " + r + "' data-id='" + l + "' dtree-id='" + p + "' data-checked='" + i + "' data-initchecked='" + i + "' data-type='" + n + "' dtree-click='" + z + "' data-par='." + N + "' dtree-disabled='" + u + "'></i>"
                    }
                    return t += "</div>"
                }
                return ""
                ...
                var e = "";
                return u && (e = x), "<cite class='" + n + " " + e + "' data-id='" + l + "' data-leaf='" + (d ? "leaf" : "node") + "' dtree-disabled='" + u + "' data-title='" + t + "' >" + o + "</cite>"
            }, ul: function () {
            ...
            fnode: function (e) {
                ...
                if ("node" == f.checkbarLoad ? b && (t = !0) : h && b && (t = !0), t) {
                    ...
                    if (e && 0 < e.length) for (var a = 0; a < e.length; a++) {
                        ...
                        var l = "";
                        u && (l = x), o += "<i class='" + r + " " + f.style.dfont + " " + f.style.cbox + " " + l + "' data-id='" + c + "' dtree-id='" + p + "' data-checked='" + n + "' data-initchecked='" + n + "' data-type='" + s + "' dtree-click='" + z + "' data-par='." + N + "' dtree-disabled='" + u + "'></i>"
                    }
                    o += "</div>", f.getNodeDom(d).snode().next("div").replaceWith(y(o))
                }
            }, text: function (e) {
                var t = "";
                u && (t = x);
                ...
                e = "{}" == e ? "" : e, d.attr("data-basic", e)
            }, recordData: function (e) {
                e = "{}" == e ? "" : e, d.attr("data-record", e)
            }, p_li: function (e) {
                var t = d.parent("li");
                return t.attr("data-id", c), e && t.attr("data-pid", e), t
            }
        }
        ...
        if (o && 0 < o.length) {
            t.obj.find("." + i).removeClass(i), t.obj.find("." + t.style.itemThis).removeClass(t.style.itemThis), o.addClass(i), o.addClass(t.style.itemThis), t.setNodeParam(o);
            var a = o.parents("." + k);
            a.children("ul").addClass(C), a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.fnode.node.close)).addClass(t.usefontStyle.fnode.node.open), a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.fnode.node.close)).removeClass(t.usefontStyle.fnode.node.close), a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.snode.node.close)).addClass(t.usefontStyle.snode.node.open), a.children("." + S).children("i[data-spread]." + de.trimToDot(t.usefontStyle.snode.node.close)).removeClass(t.usefontStyle.snode.node.close)
        }
        ...
        var t = [];
        if (t = "string" == typeof e ? e.split(",") : e, e.length) for (var o = 0; o < t.length; o++) this.setDisabledNode(this.getNodeDom(t[o]).div()); else this.setDisabledNode(this.getNodeDom(t + "").div())
        ...
        var t = e.children("div." + D).children("i[data-par]"), o = e.children("cite[data-leaf]");
        ...
        var t = [];
        if (t = "string" == typeof e ? e.split(",") : e, e.length) for (var o = 0; o < t.length; o++) this.cancelDisabledNode(this.getNodeDom(t[o]).div()); else this.cancelDisabledNode(this.getNodeDom(t + "").div())
        ...
        var t = [];
        if ((t = "string" == typeof e ? e.split(",") : e).length) for (var o = 0; o < t.length; o++) this.setHideNode(this.getNodeDom(t[o]).div()); else this.setHideNode(this.getNodeDom(t + "").div())
        ...
        var t = [];
        if ((t = "string" == typeof e ? e.split(",") : e).length) for (var o = 0; o < t.length; o++) this.cancelHideNode(this.getNodeDom(t[o]).div()); else this.cancelHideNode(this.getNodeDom(t + "").div())
        ...
        if ("" != e.trim()) {
            ...
            a.obj.find("li>div cite:contains('" + e + "')").each(function (e, t) {
                ...
                o.removeClass("layui-hide").attr("dtree-hide", !1), o.find("ul li").removeClass("layui-hide").attr("dtree-hide", !1), o.parents("li").removeClass("layui-hide").attr("dtree-hide", !1)
            })
        ...
        if (t && 0 < t.length) for (var o = 0; o < t.length; o++) {
            var a = t[o];
            e.nodeId.push(a.nodeId), e.parentId.push(a.parentId), e.context.push(a.context), e.leaf.push(a.leaf), e.level.push(a.level), e.spread.push(a.spread), e.dataType.push(a.dataType), e.checked.push(a.checked), e.initchecked.push(a.initchecked), e.basicData.push(a.basicData), e.recordData.push(a.recordData)
        }
            ...
            case Y:
                ...
                f.open({
                    ...
                    success: function (e, l) {
                        r.render(), r.on("submit(dtree_addNode_" + c.obj[0].id + "_form)", function (e) {
                            e = e.field;
                            var t = d.attr("data-id"), o = d.attr("data-id") + "_node_" + h[0].childNodes.length,
                                a = parseInt(u.attr("data-index")) + 1, i = (c.response.type, c.response.checked, []);
        ...
        switch (t) {
            case Y:
                var n = [{
                        ...
                        defElem: "nowChange",
                        verify: "required"
                    }, {type: "submit", value: "确认添加", defElem: "btn", filter: "dtree_addNode_" + o.obj[0].id + "_form"}],
            ...
            case Z:
                var h = [{
                        ...
                        defElem: "nowChange",
                        verify: "required"
                    }, {type: "submit", value: "确认编辑", defElem: "btn", filter: "dtree_editNode_" + o.obj[0].id + "_form"}],
        ...
        r.val("dtree_editNode_" + this.obj[0].id + "_form", e), r.render()
        ...
        set: function (e) {
            ...
            return "" == o ? f.msg("页面中未找到绑定id", {icon: 5}) : ("object" == typeof (t = j[o]) && t.unbindBrowserEvent(), t = new be(e), (j[o] = t).initTreePlus(), t.openTreePlus(), t.loadTreeInit(), t.bindBrowserEvent()), t
        }, renderSelect: function (e) {
            var t = null, o = de.getElemId(e);
            return "" == o ? f.msg("页面中未找到绑定id", {icon: 5}) : ("object" == typeof (t = j[o]) && t.unbindBrowserEvent(), (t = new be(e)).selectSetting(), (j[o] = t).initTreePlus(), t.openTreePlus(), t.loadTreeInit(), t.bindBrowserEvent()), t
        }, reload: function (e, t) {
            "string" == typeof e && (e = j[e]), void 0 !== e ? (e.reloadSetting(t), e.initTreePlus(), e.openTreePlus(), e.initNodeParam(), e.loadTreeInit(), e.unbindBrowserEvent(), e.bindBrowserEvent()) : f.msg("方法获取失败，请检查ID或对象传递是否正确", {icon: 2})
        }, on: function (e, t) {
            return 0 < e.indexOf("'") && (e = e.replace(/'/g, "")), 0 < e.indexOf('"') && (e = e.replace(/"/g, "")), layui.onevent.call(this, p, e, t)
        }, click: function (e, t) {
            "string" == typeof e && (e = j[e]), void 0 !== e ? y("div[dtree-click='" + X + "'][dtree-id='" + e.obj[0].id + "'][data-id='" + t + "']").click() : f.msg("方法获取失败，请检查ID或对象传递是否正确", {icon: 2})
            ...
            return "string" == typeof e && (e = j[e]), void 0 === e ? (f.msg("方法获取失败，请检查ID或对象传递是否正确", {icon: 2}), {}) : e.getCheckbarNodesParam()
        }, getCheckbarJsonArrParam: function (e) {
            return "string" == typeof e && (e = j[e]), void 0 === e ? (f.msg("方法获取失败，请检查ID或对象传递是否正确", {icon: 2}), {}) : e.getCheckbarJsonArrParam()
